...
function index_X_tabela_usuario_X_criar_novo_usuario(){            
    try{                
        
        document.getElementById("output_image").src = "arquivos/imagens/003_login/sem_imagem.gif";
        imgXX = ""; //"arquivos/imagens/003_login/sem_imagem.gif.png";
        
        document.getElementById("resposta").style.display = 'none';  
        document.getElementById("div_novo_usuario").style.display = 'block';  
        
        document.getElementById("novo_alterar_user").innerHTML = "Novo Usuário";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////   
///////////////////////////////////////////////////////////////////////////////////////////////////////////         
function _0002_01_index_X_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario(
                usuario_digitado, 
                    senha_digitada, 
                        nome_digitado,
            ...
            if (usuario_digitado === "" || usuario_digitado === null){
                ...
                _02_controle_baixar_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario( 
...
/////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
        function _01_controle_baixar_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario(
            count_x,    
        ...
        function _02_controle_baixar_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario( 
                count_x,
                usuario_digitado_recebido, 
                    senha_digitada_recebido, 
                        nome_digitado_recebido, 
...
////////////////////////////////////////////////////////////////////////////
                ...
                jQuery.getJSON( url_planilha_tabela_usuarios ).success(function(data) {
                    ...
                    _03_controle_baixar_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario(
                        JSON.stringify(data),
                        count_x,    
                            usuario_digitado_recebido, 
                                senha_digitada_recebido, 
                    ...
                    _01_controle_baixar_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario(
                        count_x,    
                            usuario_digitado_recebido, 
                                senha_digitada_recebido, 
                                    nome_digitado_recebido, 
        ...
        function _03_controle_baixar_tabela_usuario_index_X_tabela_usuario_X_criar_novo_usuario( 
                mensagem_x,
                count_x,
                usuario_digitado_recebido, 
                    senha_digitada_recebido, 
            ...
            try{
                ...
                if( tem_mensagem === true ){
                    ...
                    _0002_01_consultar_para_verificar_se_usuario_esta_cadastrado( 
                        mensagem_x,
                            usuario_digitado_recebido, 
                                senha_digitada_recebido, 
                                    nome_digitado_recebido, 
                    ...
                    _0002_01_cadastrarTabelaLogin(usuario_digitado_recebido, senha_digitada_recebido, nome_digitado_recebido, email_de_recuperacao_recebido, imagem_endereco_web_digitado_recebido, conteudo_div);
...
/////////////////////////////////////////////////////////////////////////        
        ...
        function _0002_01_consultar_para_verificar_se_usuario_esta_cadastrado( 
            mensagem,
                usuario_digitado_recebido, 
                    senha_digitada_recebido, 
                        nome_digitado_recebido, 
        ...
        function _0002_01_cadastrarTabelaLogin(
                usuario_digitado, 
                    senha_digitada, 
                        nome_digitado,
                            email_de_recuperacao,
            ...
            try{
                ...
                setTimeout(function(){ 
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    var jm_id_da_imagem_externa = exportar_Para_Alfabeto_JM_Sem_Arroba( id.trim() + "@" + jm_auto_quantidade_de_alteracoes );
                    //////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    if (imgXX === "null" || imgXX === "" || imgXX === null){
                        ...
                        try{
                            //var jm_id_complemento = exportar_Para_Alfabeto_JM_Sem_Arroba( "@1" );
                            
                            _0002_01_salvar_imagem_do_perfil( 
        ...
        function _0002_01_salvar_imagem_do_perfil( imagem, email_usuario, id_usuario ){
